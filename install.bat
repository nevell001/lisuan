...
echo                         // Ignore table not exists errors (tables will be created on app start) >> InitDatabase.java
...
if errorlevel 1 (
    ...
    echo [Info] Skipping database initialization - tables will be created on app start
...
if errorlevel 1 (
    ...
    echo [Info] Tables will be created automatically when you start the application
    del InitDatabase.java >nul 2>&1
